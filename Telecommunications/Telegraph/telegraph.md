...
Due to the rise in inventions in the field of electricity and magnetism, the invention of the telegraph, a device that allows communication using these new inventions, was bound to happen. The battery, magnetism, induction, electromagnets, and some others account for this invention. Beforehand people only knew electricity by rubbing cloth or as lightning - so short bursts of static electricity. 
...
As visible, the device itself was relatively simple to make, and there weren't many problems needing to be faced, or many improvements to be made for that time. The leading problem was, however, how to convert text into electrcal signals - in other words: the encryption.
Some inventions used 26 wires for one line, others used 5 for binary representation, and some others.  
Whilst the Europeans were baffling about this, Samuel Morse built his own telegraph and created a new, unheard of, encryption system - sound! An electromagnet would get activated on the recieving end and pull a metal piece to it, creating a "click" sound, when released, it would produce another "clack" sound. Morse's telegraph used only a single wire. The length of each button press determined the signal: short taps for dots, longer presses for dashes. By the 1840s, due to its simplicity, the Morse telegraph became the most widespread. 
